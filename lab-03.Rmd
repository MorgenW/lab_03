...
author: "zimo wang, Lim Zhen Yang, Yunhao Wang and You You - Juan's Kingdom"
date: "`r Sys.Date()`"
...
wide format doesn't have repeated value in the first column, while long format does
